...
include_once $this->targetDirs[3].'/src/DataFixtures/Profils.php';
...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\All(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\Profils(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\Tarif(), 'groups' => []]]);
